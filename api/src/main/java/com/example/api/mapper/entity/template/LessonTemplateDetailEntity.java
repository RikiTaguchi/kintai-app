...
@Data
@NoArgsConstructor
public class LessonTemplateDetailEntity {
    ...
    public static LessonTemplateDetailEntity fromDto(LessonTemplateDetailDto dto) {

        LessonTemplateDetailEntity entity = new LessonTemplateDetailEntity();
    ...
    public void applyDto(LessonTemplateDetailDto dto) {
